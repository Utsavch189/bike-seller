...
function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        className="z-50 flex w-full sticky top-0 flex-nowrap items-center justify-between bg-black text-white py-2  dark:bg-neutral-600 lg:flex-wrap lg:justify-start lg:py-4"
        data-te-navbar-ref=""
      >
